...
def linearize0():
    for i in range(img0.height):
        for j in range(img0.width):
            ...
            g=img0[i,j,1]
            r=img0[i,j,2]
            img0[i,j]=get_true_b(b,g,r)

    cv2.imwrite("lin0.jpg", img0)
...
def linearize1():
    for i in range(img1.height):
        for j in range(img1.width):
            ...
            g=img1[i,j,1]
            r=img1[i,j,2]
            img1[i,j]=get_true_b(b,g,r)

    cv2.imwrite("lin1.jpg", img1)
...
def linearize2():
    for i in range(img2.height):
        for j in range(img2.width):
            ...
            g=img2[i,j,1]
            r=img2[i,j,2]
            img2[i,j]=get_true_b(b,g,r)

    cv2.imwrite("lin2.jpg", img2)
